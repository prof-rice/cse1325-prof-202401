...
public class Controller {
    public static final String extension = ".manga";

    public Controller(String storeName) {
        this.store = new Store(storeName);
        this.filename = storeName + extension;
    ...
    private void open() {
        String filename = getString("Open from filename (press Enter to cancel): ");
    ...
    private void saveAs() {
        ...
        String temp = getString("Save as filename (press Enter to cancel): ");
