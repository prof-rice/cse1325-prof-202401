...
class Fork extends Cutlery {
    private int tines;
    public Fork(Pattern pattern, int tines) {
        super(pattern);
        this.tines = tines;
    }
    @Override
    public String toString() {
        return pattern + " fork with " + tines + " tines";
    }
}

class Knife extends Cutlery {
    private boolean serrated;
    public Knife(Pattern pattern, boolean serrated) {
        super(pattern);
        this.serrated = serrated;
    }
    @Override
    public String toString() {
        return pattern + " knife that is " + (serrated ? "" : "not ") + "serrated";
    }
}
*/
