public class TestItem {
    public static void main(String[] args) {
        ...
        Product p1 = new Product("Valiant Apricot Vinca", 1105);
        Item i1 = new Item(p1, 1);
        Product p2 = new Product("Valiant Lilac Vinca", 1200);
        ...
        String i1Expected = "  1 Valiant Apricot Vinca          $   11.05 $    11.05";
        String i2Expected = "  5 Valiant Lilac Vinca            $   12.00 $    60.00";
